            ...
            await test.step(
                ...
                async () => {
                    await expect(
                        ...
                        businessFunctionTested("Login page should display an error message for incorrect credentials"),
                    ).toBeVisible();
                },
            );
        },
            ...
            await test.step(
                ...
                async () => {
                    await expect(
                        ...
                        businessFunctionTested("Signup page should display an error message when the email is already registered"),
                    ).toBeVisible();
                },
            );
        },
            ...
            async ({ loginPage }, testInfo) => {
                ...
                await test.step(
                    ...
                    async () => {
                        expect(
                            currentUrl,
                            businessFunctionTested("User should be redirected to the base URL after logging in"),
                        ).toBe(baseUrl);
                    },
                );
                ...
                await test.step(
                    ...
                    async () => {
                        await expect(
                            ...
                            businessFunctionTested("The logout link should appear in the navigation bar"),
                        ).toBeVisible();
                    },
                );
            ...
            async ({ loginPage }) => {
                ...
                await test.step(
                    ...
                    async () => {
                        await expect(
                            loginPage.header.logoutLink,
                            businessFunctionTested("The logout link should remain visible prior to session termination"),
                        ).toBeVisible();
                    },
                );
            },
